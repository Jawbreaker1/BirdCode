...
use birdcode_protocol::{
    ...
    ClientCommand, CreateRunRequest, CreateSessionRequest, EventPayload, Health, HealthStatus,
    InitializeResult, InputItem, MAX_ARTIFACT_CHUNK_BYTES, PlanAcceptanceContract,
...
use event_projection::project_event;
