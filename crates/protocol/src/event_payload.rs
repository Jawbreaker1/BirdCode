...
use super::{
    ...
    ChildModelInferencePrepared, ChildModelInferencePreparedV2, ChildToolDispatchStartedV2,
    ChildToolObserved, ChildToolObservedV2, ChildToolOutcomeUnknown, ChildToolOutcomeUnknownV2,
    ChildToolPrepared, ChildToolPreparedV2, ChildWorkOrderIssued, InputItem, PlanProposalAccepted,
...
pub enum EventPayload {
    ...
    ChildToolDispatchStartedV2(ChildToolDispatchStartedV2),
